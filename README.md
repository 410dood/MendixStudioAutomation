...
npm run open-page-widget-properties -- --page "Client_ClinicalDocument_V3" --widget "Structure mode"
...
npm run export-review-page-widget-properties -- --page "Client_ClinicalDocument_V3" --widget "Structure mode" --fields-file ".automation-state/structure-mode-properties.json" --items-file ".automation-state/structure-mode-items.json" --output-file ".automation-state/structure-mode-review.json" --finalize-dialog "Cancel"
...
npm run open-page-explorer-item-properties -- --page "Client_ClinicalDocument_V3" --item "container34" --scope pageExplorer
...
npm run export-review-page-explorer-item-properties -- --page "Client_ClinicalDocument_V3" --item "container34" --scope pageExplorer --fields-file ".automation-state/container34-properties.json" --items-file ".automation-state/container34-items.json" --output-file ".automation-state/container34-review.json" --finalize-dialog "Cancel"
