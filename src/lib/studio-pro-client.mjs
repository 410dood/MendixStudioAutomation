...
export class StudioProClient {
    ...
    async openPageWidgetProperties(options = {}) {
        const normalized = normalizePageWidgetPropertyOptions(options);
    ...
    async setPageWidgetProperties(options = {}) {
        const normalized = normalizePageWidgetPropertyOptions(options);
        return this.setPropertiesDialogFields({
            ...options,
            page: normalized.page,
            item: normalized.widget,
            scope: normalized.scope,
    ...
    async openPageExplorerItemProperties(options = {}) {
        const normalized = normalizePageExplorerPropertyOptions(options);
        return this.openProperties({
            ...options,
            page: normalized.page,
    ...
    async setPageExplorerItemProperties(options = {}) {
        const normalized = normalizePageExplorerPropertyOptions(options);
        return this.setPropertiesDialogFields({
            ...options,
            page: normalized.page,
    ...
    async comparePageExplorerItemProperties(options = {}) {
        const normalized = normalizePageExplorerPropertyOptions(options);
        return this.comparePropertiesDialog({
            ...options,
            page: normalized.page,
    ...
    async inspectPageExplorerItemProperties(options = {}) {
        const normalized = normalizePageExplorerPropertyOptions(options);
        const fieldsResult = await this.listPropertiesDialogFields({
            ...options,
            page: normalized.page,
        ...
        if (!fieldsResult?.ok) {
            return {
                ...fieldsResult,
                action: "inspect-page-explorer-item-properties"
            };
        }
    ...
    async exportPropertiesDialog(options = {}) {
        let openResult;
        try {
            openResult = await this.openProperties(options);
        } catch (error) {
        ...
        const exportResult = await this.exportDialogFields({
            ...options,
            dialog: dialogName
        });
    ...
    async comparePropertiesDialog(options = {}) {
        ...
        const comparison = await this.compareDialogFields({
            ...options,
            dialog: dialogName
        });
    ...
    async getPropertiesDialogField(options = {}) {
        ...
        const fieldResult = await this.getDialogField({
            ...options,
            dialog: dialogName
        });
    ...
    async setPropertiesDialogField(options = {}) {
        let openResult;
        try {
            openResult = await this.openProperties(options);
        } catch (error) {
        ...
        const fieldResult = await this.setDialogField({
            ...options,
            dialog: dialogName
        });
        const finalizeResult = await finalizePropertiesDialogAction(this, dialogName, options, fieldResult?.ok);
...
function normalizePageExplorerPropertyOptions(options) {
    const page = options.page ?? options.document ?? null;
    const item = options.item ?? options.widget ?? null;
    const scope = options.scope ?? "pageExplorer";
    const dryRun = toBoolean(options.dryRun, false);
    const finalizeDialog = options.finalizeDialog ?? (dryRun ? "Cancel" : "OK");
    return {
        page,
